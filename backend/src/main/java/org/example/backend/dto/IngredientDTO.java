...
public class IngredientDTO {
    ...
    private Ingredient.LoaiProtein loaiProtein;
    private Ingredient.TrangThai trangThai;
    ...
    public Ingredient.LoaiProtein getLoaiProtein() {
        return loaiProtein;
    }

    public void setLoaiProtein(Ingredient.LoaiProtein loaiProtein) {
        this.loaiProtein = loaiProtein;
    }

    public Ingredient.TrangThai getTrangThai() {
        return trangThai;
    }
